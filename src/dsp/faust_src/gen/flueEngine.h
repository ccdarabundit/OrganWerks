...
#ifndef  __flueEngine_H__
#define  __flueEngine_H__
...
class flueEngine : public dsp {
 ...
 public:
	...
	virtual flueEngine* clone() {
		return new flueEngine();
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("flue");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow1 = (fConst0 * ((0.0011363636f / fSlow0) - float(fEntry1)));
		float fSlow2 = (fSlow1 + -3.49999499f);
		float fSlow3 = std::floor(fSlow2);
		float fSlow4 = (fSlow1 + (-3.0f - fSlow3));
		float fSlow5 = (fSlow1 + (-4.0f - fSlow3));
		float fSlow6 = (fSlow1 + (-5.0f - fSlow3));
		float fSlow7 = (fSlow1 + (-6.0f - fSlow3));
		...
		float fSlow51 = (fSlow1 + (-2.0f - fSlow3));
		...
		float fSlow61 = (fConst6 * float(fEntry10));
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			float fTemp1 = ((fRec6[0] + fRec2[1]) - (fRec7[0] * float(tanhf(float(((fSlow17 * fVec1[((IOTA - iSlow25) & 4095)]) + (fSlow26 * ((((fSlow27 * fVec1[((IOTA - iSlow29) & 4095)]) + (fSlow30 * fVec1[((IOTA - iSlow32) & 4095)])) + (fSlow34 * fVec1[((IOTA - iSlow36) & 4095)])) + (fSlow37 * fVec1[((IOTA - iSlow39) & 4095)])))))))));
			fVec2[(IOTA & 4095)] = fTemp1;
			float fTemp2 = ((fSlow17 * fVec2[((IOTA - iSlow40) & 4095)]) + (fSlow26 * ((((fSlow27 * fVec2[((IOTA - iSlow41) & 4095)]) + (fSlow30 * fVec2[((IOTA - iSlow42) & 4095)])) + (fSlow34 * fVec2[((IOTA - iSlow43) & 4095)])) + (fSlow37 * fVec2[((IOTA - iSlow44) & 4095)]))));
			fRec5[0] = (fTemp2 - ((fSlow45 * fRec5[1]) + (fSlow46 * fRec5[2])));
			float fTemp3 = (((fSlow9 * fRec5[0]) + (fSlow47 * fRec5[1])) + (fSlow48 * fRec5[2]));
			fVec3[(IOTA & 4095)] = fTemp3;
			fRec2[0] = ((fSlow8 * fVec3[((IOTA - iSlow50) & 4095)]) + (fSlow51 * ((((fSlow52 * fVec3[((IOTA - iSlow53) & 4095)]) + (fSlow54 * fVec3[((IOTA - iSlow55) & 4095)])) + (fSlow57 * fVec3[((IOTA - iSlow58) & 4095)])) + (fSlow59 * fVec3[((IOTA - iSlow60) & 4095)]))));
			float fRec3 = (0.850000024f * fTemp2);
			float fRec4 = (0.150000006f * fTemp1);
			fRec0[0] = fRec2[0];
			...
			float fTemp4 = ((fRec1 * fRec10[0]) * std::max<float>(0.0f, (std::min<float>((fSlow62 * float(iRec11[0])), 1.0f) - (fConst7 * float(iRec12[0])))));
