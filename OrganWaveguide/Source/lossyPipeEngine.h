...
class lossyPipeEngine : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst6 = (1.0f / std::max<float>(1.0f, (0.11f * fConst0)));
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
        ...
        float fSlow8 = (fSlow3 + (-1.0f - fSlow7));
        ...
        int iSlow14 = (std::min<int>(iConst3, std::max<int>(0, iSlow13)) + 1);
        float fSlow15 = (0.00100000005f * float(fEntry4));
        float fSlow16 = (fSlow3 - fSlow7);
        float fSlow17 = (((0.0f - fSlow9) * (0.0f - (0.5f * fSlow10))) * (0.0f - (0.333333343f * fSlow11)));
        int iSlow18 = (std::min<int>(iConst3, std::max<int>(0, (iSlow13 + 1))) + 1);
        float fSlow19 = (0.5f * ((fSlow8 * (0.0f - fSlow10)) * (0.0f - (0.5f * fSlow11))));
        int iSlow20 = (std::min<int>(iConst3, std::max<int>(0, (iSlow13 + 2))) + 1);
        float fSlow21 = (fSlow8 * fSlow9);
        float fSlow22 = (0.166666672f * (fSlow21 * (0.0f - fSlow11)));
        int iSlow23 = (std::min<int>(iConst3, std::max<int>(0, (iSlow13 + 3))) + 1);
        float fSlow24 = (0.0416666679f * (fSlow21 * fSlow10));
        int iSlow25 = (std::min<int>(iConst3, std::max<int>(0, (iSlow13 + 4))) + 1);
        ...
        for (int i = 0; (i < count); i = (i + 1)) {
            ...
            float fTemp0 = (fSlow12 * fRec1[((IOTA - iSlow14) & 8191)]);
            fRec4[0] = (fSlow15 + (0.999000013f * fRec4[1]));
            float fTemp1 = (fSlow16 * ((((fSlow17 * fRec1[((IOTA - iSlow18) & 8191)]) + (fSlow19 * fRec1[((IOTA - iSlow20) & 8191)])) + (fSlow22 * fRec1[((IOTA - iSlow23) & 8191)])) + (fSlow24 * fRec1[((IOTA - iSlow25) & 8191)])));
            fRec5[0] = (fSlow26 + (0.999000013f * fRec5[1]));
            fRec6[0] = (fSlow35 + (0.999000013f * fRec6[1]));
            iVec0[0] = iSlow36;
            iRec7[0] = ((1103515245 * iRec7[1]) + 12345);
            float fTemp2 = ((fRec6[0] * (fTemp0 + fTemp1)) + (fSlow37 * float(iRec7[0])));
